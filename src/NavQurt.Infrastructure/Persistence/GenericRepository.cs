    ...
    where TContext : DbContext
{
    ...
    protected GenericRepository(TContext context, IUnitOfWork unitOfWork)
    {
        Context = context;
    ...
    {
        return predicate == default
            ? Context.Set<TEntity>().SumAsync(selector)
    ...
    {
        return predicate == default
            ? Context.Set<TEntity>().ToDictionaryAsync(keySelector)
