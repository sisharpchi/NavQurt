...
namespace NavQurt.Server.Areas.Admin.Pages.Incomes;
    ...
    IIngredientService ingredientService) : PageModel
{
    ...
    [BindProperty]
    public IncomeInput Input { get; set; } = CreateEmptyInput();
    ...
    public async Task<IActionResult> OnPost(CancellationToken cancellationToken)
    {
        ...
        Message = result.Success ? "Prixod qilindi." : result.Error;
    ...
    public class IncomeInput
    {
        ...
        public List<IncomeItemInput> Items { get; set; } = new();
    }
