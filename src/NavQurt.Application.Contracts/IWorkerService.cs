...
public interface IWorkerService
{
    ...
    Task<ResponseResult<ListResponse<WorkerDto>>> GetListAsync(WorkerListRequest request, CancellationToken cancellationToken = default);
    Task<ResponseResult<WorkerDto>> GetAsync(int id, CancellationToken cancellationToken = default);
