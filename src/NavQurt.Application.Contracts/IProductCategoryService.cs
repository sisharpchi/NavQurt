...
public interface IProductCategoryService
{
    ...
    Task<ResponseResult<ListResponse<ProductCategoryDto>>> GetListAsync(ProductCategoryListRequest request, CancellationToken cancellationToken = default);
    Task<ResponseResult<ProductCategoryDto>> GetAsync(int id, CancellationToken cancellationToken = default);
